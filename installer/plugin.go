...
func (inst *Installer) GetPluginDetails(pluginName string) *dto.Plugin {
...
func (inst *Installer) GetPluginsStorePluginFile(plugin dto.Plugin) (pluginsPath string, err error) {
